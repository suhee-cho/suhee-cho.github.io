...
{% if site.display_tags and site.display_tags.size > 0 %}
  ...
  <div class="tag-list">
    <p class="keywords-title" style="color: #fff;">Keywords :open_file_folder:</p>

    <ul class="keywords-list">
      {% if tags != "" %}
        {% for tag in site.display_tags %}
          <li class="keywords-item">
            <a class="tag-label" href="{{ tag | slugify | prepend: '/blog/tag/' | relative_url }}">
...
<div class="page-paper">
  <ul class="post-list">
    ...
    <li>
      ...
      <p class="post-tags">
        <a class="black-red-button" href="{{ year | prepend: '/blog/' | relative_url }}">
